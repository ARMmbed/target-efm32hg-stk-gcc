...
#
add_definitions("-DEFM32HG322F64 -DEFM32HG -DEFM32 -DDEBUG_EFM -DARM_MATH_CM0PLUS")

# append non-generic flags, and set EFM32HG-specific link script

set(_CPU_COMPILATION_OPTIONS "-mcpu=cortex-m0plus -mthumb -D__thumb2__ -g -g3 -gdwarf-3 -gstrict-dwarf")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT    "${CMAKE_EXE_LINKER_FLAGS_INIT} -mcpu=cortex-m0plus -mthumb -T\"${CMAKE_CURRENT_LIST_DIR}/../ld/efm32hg.ld\"")